Ext.define('GbZh.geoext.PrintExtent', {
	alias: 'plugin.printextent',
	mixins: {
	...
	init: function (mapComponent) {
		//LOG console.log("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii");
		var me = this;
...
/*
		var printPage = Ext.create('GbZh.geoext.PrintPage', {
 ...
 */
	...
	addPage: function (page) {
		...
		page = page || Ext.create('GbZh.geoext.PrintPage', {
...
//		if (this.pages.indexOf(page) === -1) {
	...
	onMapPanelDestroy: function () {
		...
		for (len = this.pages.length - 1, i = len; i >= 0; i--) {
