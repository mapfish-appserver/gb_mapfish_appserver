class Wms
  ...
  # return SLD for selection (nil if layer is unknown)
  def self.sld_selection(topic, layer_name, filter_property, filter_values)
    layer = topic.layers.find_by_name(layer_name)
    if layer.nil?
      return nil
    end
